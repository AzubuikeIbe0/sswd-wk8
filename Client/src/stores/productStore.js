...
export const deleteProduct = async (product = '') => {
    ...
    if (product) {
        // build the request using the intRequest function
        const request = initRequest('DELETE', product);

        // Make th request via getAPIData() function
        const result = await getAPIData('/:id', request);
      ...
      // In case of error  
        ...
        console.log('Store: Delete product unsuccesful: missing product');
    }
}
...
export const updateProduct = async (product = '') => {
    ...
    if (product) {
        // build the request using the intRequest function
        const request = initRequest('PUT', product);
      ...
      // In case of error  
        ...
        console.log('Store: Update product failed: Problem updating product');
    }
